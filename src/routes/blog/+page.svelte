                ...
                <div class="flex-1 pr-6">
                    <div class="flex justify-between mb-3">
                        <div class="flex items-center gap-2 ">
                            <span class="bg-blue-700 text-white text-xs font-medium px-2.5 py-0.5 rounded-full">Arcana</span>
                        </div>
                    ...
                    <p class="text-black leading-relaxed">
                        When developing the product ethos behind Arcana, my productivity timer, I began to realize that building an operating system native timer was a critical piece of an effective product approach.
                    </p>
